...
public class AllAreaSubscriptions extends AppCompatActivity implements AsyncResponse {
    ...
    private AllAreaSubscriptionAdpater allAreaSubscriptionAdpater;
    private List<AreaList> areaLists = new ArrayList<>();
    SharedPreferences sharedPreferences;
    String adminmobile;
    private String TAG = AllAreaSubscriptions.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_area_subscriptions);
    ...
    public void initView() {
        ...
        addNewStationTv.setText("Area List");
        ...
        allAreaSubscriptionAdpater = new AllAreaSubscriptionAdpater(areaLists);
        ...
        recyclerView.setAdapter(allAreaSubscriptionAdpater);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AllAreaSubscriptions.this, DashBoardActivity.class);
    ...
    private void loadData() {
        ...
        new SendRequest(getResources().getString(R.string.url), jo, AllAreaSubscriptions.this,
    ...
    public void onResponse(JSONObject jsonObject) {
        ...
        allAreaSubscriptionAdpater.notifyDataSetChanged();
    }
