...
public class BottomSheetManageSystemFragment extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getContext(), R.layout.bottom_sheet_manage_system_fragment, null);
