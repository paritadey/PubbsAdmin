...
import admin.pubbs.in.pubbsadminnew.Adapter.ServiceAdpater;
...
public class StartStopService extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(serviceAdpater);
    ...
    private void loadData() {
        ...
        new SendRequest(getResources().getString(R.string.url), jo, StartStopService.this,
