...
public class AllAreaRateChart extends AppCompatActivity implements AsyncResponse {
    ...
    private AllAreaRateAdapter allAreaRateAdapter;
    private List<AreaList> areaLists = new ArrayList<>();
    SharedPreferences sharedPreferences;
    String adminmobile;
    private String TAG = AllAreaRateChart.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_area_rate_chart);
    ...
    public void initView() {
        ...
        allAreaRateAdapter = new AllAreaRateAdapter(areaLists);
        ...
        recyclerView.setAdapter(allAreaRateAdapter);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AllAreaRateChart.this, DashBoardActivity.class);
    ...
    private void loadData() {
        ...
        new SendRequest(getResources().getString(R.string.url), jo, AllAreaRateChart.this,
    ...
    public void onResponse(JSONObject jsonObject) {
        ...
        allAreaRateAdapter.notifyDataSetChanged();
    }
